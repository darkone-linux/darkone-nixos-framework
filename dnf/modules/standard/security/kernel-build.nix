...
let
  ...
  cfg = config.darkone.security.kernelBuild;
...
{
  options = {
    darkone.security.kernelBuild.enable = lib.mkEnableOption "Active le module de recompilation noyau ANSSI (R15–R27).";
  };

  config = lib.mkMerge [
    { darkone.security.kernelBuild.enable = lib.mkDefault mainSecurityCfg.enable; }
